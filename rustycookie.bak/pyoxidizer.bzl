...
def make_exe():
    ...
    # python_config.run_command = "import cookiecutter.cli; cookiecutter.cli.version_msg()"

    # Run a Python module as __main__ when the interpreter starts.
    python_config.run_module = "cookiecutter.cli"

    # Run a Python file when the interpreter starts.
    # python_config.run_filename = "cookiecutter"
